...
::: {.r-stack}
![](./media/import_image_data_full){.fragment style="position: absolute; left: 0; z-index: 1;"}
![](./media/import_image_data_group){.fragment style="position: absolute; left: 0; z-index: 2;"}
![](./media/import_image_data_project){.fragment style="position: absolute; left: 0; z-index: 3;"}
![](./media/import_image_data_dataset){.fragment style="position: absolute; left: 0; z-index: 4;"}
![](./media/import_image_data_images){.fragment style="position: absolute; left: 0; z-index: 5;"}
:::
