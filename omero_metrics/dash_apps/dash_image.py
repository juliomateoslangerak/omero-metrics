...
dash_app_image.layout = dmc.MantineProvider([dmc.Container(id='main', children=[
    ...
    dmc.Grid(
        ...
        style={"margin-top": "20px", "margin-bottom": "20px", "border": "1px solid #63aa47", "padding": "10px", "border-radius": "0.5rem", "background-color": "white"}
    ),

    dcc.Graph(figure={}, id="rois-graph", style={"margin-top": "20px", "margin-bottom": "20px",  "border-radius": "0.5rem"}),
    html.Div([
        dmc.Title("Intensity Profiles", c="#63aa47", size="h3"),
        dcc.Graph(id='intensity_profiles', figure={},style={"margin-top": "20px", "margin-bottom": "20px",  "border-radius": "0.5rem"}),
    ])
