...
from omero_metrics.dash_apps import dash_image_psf_beads
from omero_metrics.dash_apps import dash_dataset_metrics
...
urlpatterns = [
    ...
    re_path(r'^dataset/(?P<dataset_id>[0-9]+)/', center_viewer_dataset_yaml, name='dataset'),
