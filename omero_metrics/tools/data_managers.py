...
class DatasetManager:
    """
    This class is a unit of work that processes data from a \
    dataset or a dataset_collection (OMERO-project)
    ...
    def process_data(
        ...
        self._update_dataset_input_config(
            config
        )
        self.analysis_func(
            self.mm_dataset
