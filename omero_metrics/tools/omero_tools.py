...
def create_shape_rectangle(
    mm_rectangle: mm_schema.Rectangle,
):
    rect = RectangleI()
...
def create_table(
    ...
    """Creates a table annotation from a pandas \
    dataframe or a list of columns as dictionaries."""
