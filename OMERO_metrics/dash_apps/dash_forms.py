...
# analysis_types = [ {"label": dft.add_space_between_capitals(str(field.__name__).replace("InputParameters", "")), "value": field.__name__}
...
#     if analysis_type in ALLOWED_ANALYSIS_TYPES:
#         ana = getattr(mm_schema, analysis_type)
...
#         ):
#             sleep(2)
#             mm_input_parameters = getattr(mm_schema, analysis_type)
